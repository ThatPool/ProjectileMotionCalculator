...
public class Cannon : MonoBehaviour {
    ...
    private void HandleControls() {
        if (Input.GetKey(KeyCode.W)) _barrelPivot.Rotate(Vector3.right * _rotateSpeed * Time.deltaTime);
        else if (Input.GetKey(KeyCode.S)) _barrelPivot.Rotate(Vector3.left * _rotateSpeed * Time.deltaTime);
